 ...
 */
public class TransInfoOMHotBlogUtils extends TransInfoUtils {
	/**
	 * 自身默认实例
	 */
	private static TransInfoOMHotBlogUtils instance;

	/**
	 * 构造函数
	 */
	public TransInfoOMHotBlogUtils() {
	 ...
	 * @return
	 */
	public static TransInfoOMHotBlogUtils getDefaultInstance() {
		if (instance == null) {
			instance = new TransInfoOMHotBlogUtils();
		}
		return instance;
	}
	...
	private CTransInfo generateCTransInfo(String _sTransModelDefine, PDMEditTrans _pageDataModel, int _iDateInter) throws STATransException {
		...
		_paramList[7] = _sStorageDBHost; // 数据处理参数列表
		_paramList[8] = _sStorageDBPort;
		_paramList[9] = _sStorageDBUser;
		_paramList[10] = _sStorageDBPassword;
		_paramList[11] = _sStorageDBTable;
