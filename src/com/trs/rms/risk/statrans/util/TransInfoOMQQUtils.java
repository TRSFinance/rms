...
public class TransInfoOMQQUtils extends TransInfoUtils{
	private static TransInfoOMQQUtils instance;
	public TransInfoOMQQUtils(){

	}
	public static TransInfoOMQQUtils getDefaultInstance() {
		if (instance == null) {
			instance = new TransInfoOMQQUtils();
		}
		return instance;
	}
