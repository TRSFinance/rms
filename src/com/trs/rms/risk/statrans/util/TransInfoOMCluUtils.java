 ...
 */
public class TransInfoOMCluUtils extends TransInfoUtils {
	/**
	 * 自身默认实例
	 */
	private static TransInfoOMCluUtils instance;

	/**
	 * 构造函数
	 */
	public TransInfoOMCluUtils() {
	 ...
	 * @return
	 */
	public static TransInfoOMCluUtils getDefaultInstance() {
		if (instance == null) {
			instance = new TransInfoOMCluUtils();
		}
		return instance;
	}
