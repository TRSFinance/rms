 ...
 */
public class TransInfoWeiboANPUtils extends TransInfoUtils {
	/**
	 * 自身默认实例
	 */
	private static TransInfoWeiboANPUtils instance;

	/**
	 * 构造函数
	 */
	public TransInfoWeiboANPUtils() {
	 ...
	 * @return
	 */
	public static TransInfoWeiboANPUtils getDefaultInstance() {
		if (instance == null) {
			instance = new TransInfoWeiboANPUtils();
		}
		return instance;
	}
