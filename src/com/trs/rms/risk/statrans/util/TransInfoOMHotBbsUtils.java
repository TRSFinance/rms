 ...
 */
public class TransInfoOMHotBbsUtils extends TransInfoUtils {
	/**
	 * 自身默认实例
	 */
	private static TransInfoOMHotBbsUtils instance;

	/**
	 * 构造函数
	 */
	public TransInfoOMHotBbsUtils() {
	 ...
	 * @return
	 */
	public static TransInfoOMHotBbsUtils getDefaultInstance() {
		if (instance == null) {
			instance = new TransInfoOMHotBbsUtils();
		}
		return instance;
	}
	...
	private CTransInfo generateCTransInfo(String _sTransModelDefine, PDMEditTrans _pageDataModel, int _iDateInter) throws STATransException {
		...
		_paramList[10] = _sStorageDBHost;
		_paramList[11] = _sStorageDBPort;
		_paramList[12] = _sStorageDBUser;
		_paramList[13] = _sStorageDBPassword;
		_paramList[14] = _sStorageDBTable;
