 ...
 */
public class TransInfoOMHotNewsUtils extends TransInfoUtils {
	/**
	 * 自身默认实例
	 */
	private static TransInfoOMHotNewsUtils instance;

	/**
	 * 构造函数
	 */
	public TransInfoOMHotNewsUtils() {
	 ...
	 * @return
	 */
	public static TransInfoOMHotNewsUtils getDefaultInstance() {
		if (instance == null) {
			instance = new TransInfoOMHotNewsUtils();
		}
		return instance;
	}
