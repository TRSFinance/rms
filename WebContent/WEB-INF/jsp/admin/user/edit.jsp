				...
				<div class="box col-md-12">
					<div class="box-inner">
						<div class="box-header well">
							<h2>
								<i class="glyphicon glyphicon-eye-open"></i>修改用户信息
							</h2>


						</div>
						<div class="box-content">
							<form action="<%=ctx %>/admin/rmsUser/edit.do" method="post"
								id="_edituser">
								...
								<table class="table table-bordered table-striped">
									...
									<tbody>
										<tr>
											<td><span class="label-default label">登录名称</span></td>
										...
										<tr>
											<td><span class="label-warning label label-default">手
													机</span></td>
											<td><input type="text" name="moblie"
												value="${user.mobile } " class="form-control" datatype="m"
										...
										<tr>
											...
											<td><input type="text" name="email"
												value="${user.email } " class="form-control" datatype="e"
												errormsg="请输入正确的邮箱地址！" ignore="ignore"></td>
										</tr>
										<tr>
											<td><span class="label-info label label-default">状
													态</span></td>
